...
echo "$($PSQL "SELECT name FROM games FULL JOIN teams on games.winner_id = team_id OR games.opponent_id = team_id WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name ASC")"
